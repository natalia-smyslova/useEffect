...
![useEffect](https://github.com/natalia-smyslova/ra16-homeworks/raw/master/hooks-context/use-effect/assets/use-effect.png)

При первой загрузке ни один из элементов не выбран, поэтому отображается только список:

![First load](https://github.com/natalia-smyslova/ra16-homeworks/raw/master/hooks-context/use-effect/assets/first-load.png)
